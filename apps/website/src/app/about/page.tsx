export default function AboutPage() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-20">
      ...
      <h1 className="mt-3 text-5xl font-black text-zinc-950">Moorish Concierge is a Marrakech concierge service brand.</h1>
      <div className="mt-8 space-y-6 text-lg leading-8 text-zinc-700">
        <p>
          Moorish Concierge helps visitors discover comfortable stays and trusted services in Marrakech, from villas and apartments to excursions, transportation, SPA, and restaurants.
        </p>
        <p>
