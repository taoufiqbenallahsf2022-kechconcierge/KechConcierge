...
export const categoryDescriptions: Record<Category, string> = {
  ...
  apartments: "Modern apartments and studios for couples, families, and business travelers.",
...
const img = {
  ...
  apartmentA: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267",
  apartmentB: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688",
  apartmentC: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2",
  apartmentD: "https://images.unsplash.com/photo-1560448075-bb485b067938",
  apartmentE: "https://images.unsplash.com/photo-1484154218962-a197022b5858",
...
export const catalogItems: CatalogItem[] = [
...

  {
    id: "a1",
    category: "apartments",
    slug: "gueliz-modern-apartment",
    title: "Gueliz Modern Apartment",
    location: "Gueliz, Marrakech",
    price: "From €75 / night",
    images: gallery(img.apartmentA, img.apartmentB, img.apartmentC, img.apartmentD),
    shortDescription: "Central apartment with air conditioning and modern comfort.",
    description: "A practical city apartment close to restaurants, cafés, shops, and transport.",
  ...
  },
  {
    ...
    price: "From €55 / night",
    images: gallery(img.apartmentB, img.apartmentA, img.apartmentE, img.apartmentC),
  ...
  },
  {
    ...
    price: "From €65 / night",
    images: gallery(img.apartmentC, img.apartmentD, img.apartmentA, img.apartmentB),
    shortDescription: "One-bedroom apartment near Majorelle Garden.",
    description: "A bright apartment for couples or solo travelers who want a comfortable stay near popular Marrakech spots.",
  ...
  },
  {
    id: "a4",
    category: "apartments",
    slug: "family-apartment-agdal",
    title: "Family Apartment Agdal",
    location: "Agdal, Marrakech",
    price: "From €90 / night",
    images: gallery(img.apartmentD, img.apartmentE, img.apartmentB, img.apartmentC),
    shortDescription: "Spacious apartment for families with two bedrooms.",
    description: "A practical apartment for families needing space, kitchen, air conditioning, and easy access to the city.",
  ...
  },
  {
    ...
    images: gallery(img.apartmentE, img.apartmentA, img.apartmentD, img.apartmentC),
    shortDescription: "Premium flat with stylish design and central location.",
    description: "A higher-comfort apartment for guests who want style, comfort, and premium surroundings.",
