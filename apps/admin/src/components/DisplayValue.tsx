...
import {ProductGalleryViewer} from './ProductImageGallery';
...
export function DisplayValue({field,value}:{field?:Field;value:unknown}){
 ...
 if(field?.kind==='imageGallery')return <ProductGalleryViewer images={Array.isArray(value)?value.map(String):[]}/>;
