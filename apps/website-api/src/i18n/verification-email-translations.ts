...
const emailTranslations = {
  en: {
    verifySubject: "Verify your Moorish Concierge account",
    eyebrow: "Moorish Concierge",
    title: "Verify your account",
    line1: "Thank you for creating your Moorish Concierge account.",
    line2: "Please click the button below to verify your email address and activate your account.",
    button: "Verify account",
    fallback: "If the button does not work, copy and paste this link into your browser:",
  },
  fr: {
    verifySubject: "Vérifiez votre compte Moorish Concierge",
    eyebrow: "Moorish Concierge",
    title: "Vérifiez votre compte",
    line1: "Merci d’avoir créé votre compte Moorish Concierge.",
  ...
  es: {
    verifySubject: "Verifica tu cuenta Moorish Concierge",
    eyebrow: "Moorish Concierge",
    title: "Verifica tu cuenta",
    line1: "Gracias por crear tu cuenta Moorish Concierge.",
  ...
  pt: {
    verifySubject: "Verifique a sua conta Moorish Concierge",
    eyebrow: "Moorish Concierge",
    title: "Verifique a sua conta",
    line1: "Obrigado por criar a sua conta Moorish Concierge.",
  ...
  it: {
    verifySubject: "Verifica il tuo account Moorish Concierge",
    eyebrow: "Moorish Concierge",
    title: "Verifica il tuo account",
    line1: "Grazie per aver creato il tuo account Moorish Concierge.",
  ...
  de: {
    verifySubject: "Bestätigen Sie Ihr Moorish Concierge-Konto",
    eyebrow: "Moorish Concierge",
    title: "Konto bestätigen",
    line1: "Vielen Dank, dass Sie Ihr Moorish Concierge-Konto erstellt haben.",
